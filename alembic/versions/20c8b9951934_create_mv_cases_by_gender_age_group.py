"""create_mv_cases_by_gender_by_group.py

Revision ID: 20c8b9951934
Revises: 16aa33840134
...
def upgrade():
    op.execute("""
        CREATE MATERIALIZED VIEW mv_cases_by_gender_age_group AS
        SELECT
            nu_ano,
            sg_uf_not,
            CASE
        ...
        GROUP BY nu_ano, sg_uf_not, sexo, faixa_inicio;
    """)
